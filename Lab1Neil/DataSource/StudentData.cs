...
namespace Lab1Neil.DataSource
{
    public class StudentData
    {
        ...
        protected StudentData()
        {
            ...
            myList.Add(new Student("2723246", "Janae Shepherd","sdexter@yahoo.ca", "MQPOSXIY","https://cdn.xxl.thumbs.canstockphoto.com/beautiful-woman-afro-with-glasses-avatar-character-icon-vector-illustration-design-image_csp76770577.jpg"));
